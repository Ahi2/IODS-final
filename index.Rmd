...
# Analysis
In this section I perform the analysis needed to test my hypotheses. I start with multiple linear regression and will end the report by running a linear discriminant analysis. 

I first begin with testing the first hypothesis. To do so, I need to conduct a multiple linear analysis. 
...
The first analysis is a multiple linear regression. 
